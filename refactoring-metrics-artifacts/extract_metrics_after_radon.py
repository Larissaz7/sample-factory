...
cc_data  = rodar_radon(["radon", "cc",  "./sample_factory", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./sample_factory", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./sample_factory", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./sample_factory", "-j"])
