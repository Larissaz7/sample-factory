...
cc_data  = rodar_radon([sys.executable, "-m", "radon", "cc",  "./sample_factory", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon([sys.executable, "-m", "radon", "mi",  "./sample_factory", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon([sys.executable, "-m", "radon", "hal", "./sample_factory", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon([sys.executable, "-m", "radon", "raw", "./sample_factory", "-j"])
